		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">No. Telepon</h3>
						<ul class="breadcrumb-tree">
							<li><a href="#">Home</a></li>
							<li><a href="#">Akun Saya</a></li>
                            <li class="active">No. telepon</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
			...
			<div class="container">
                ...
                <?php echo $this->session->flashdata('gagal') ?>
                    ...
                    <div class="header">
                        ...
                        <p>Untuk keamanan Anda, mohon ikuti langkah berikut untuk mengganti no. telepon Anda.</p>
                    </div>
                    ...
                    <div style="padding-left: 200px; padding-right: 200px; padding-top: 20px">
                        ...
                        <form method="POST" action=<?php echo base_url('akun_saya/check_password_for_notelp') ?>>

                            <input type="hidden" name="id_pembeli" value="<?php echo $data->id ?>">

                            <div class="form-group row" style="padding-bottom: 20px">
                                <label class="col-sm-2 col-form-label" style="font-weight: 400">No. Telepon Saat Ini</label>
                                <div class="col-sm-10">
