    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="breadcrumb-tree">
          ...
          <li class="active">Komputer & Otomatisasi Kantor</li>
        </ul>
      </div>
    </div>
    <!-- /row -->
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div id="aside" class="col-md-3">
        <!-- aside Widget -->
        <h2>Komputer & Otomatisasi Kantor</h2>
        <hr>
        <div class="aside">
              ...
              <div class="store-grid">
                <form class="form-inline">
                  <div class="input-group">
                    ...
                    <input class="form-control mr-sm-2" type="search" id="search_text" placeholder="Cari Komputer & Otomatisasi Kantor" style="width: 400px"  aria-describedby="basic-addon1">
                  </div>
                </form>
              </div>
            </div>
...
$(document).ready(function(){
    ...
    function filter_data(page)
    {
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>kategori/fetch_komputer/"+page,
            method:"POST",
            dataType:"JSON",
