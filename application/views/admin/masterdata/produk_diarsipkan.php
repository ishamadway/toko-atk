<div id="layoutSidenav_content">
                <main>
                  ...
                  <div class="row">
                    ...
                    <ul class="nav nav-tabs">
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('admin/produk/all') ?>">Semua</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('admin/produk/habis') ?>">Habis</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="#">Diarsipkan</a>
                      </li>
                    </ul>
                ...
                $(document).ready(function(){
                    ...
                    function filter_data(page)
                    {
                        ...
                        $.ajax({
                            url:"<?php echo base_url(); ?>admin/produk/fetch_data_arsip/"+page,
                            method:"POST",
                            dataType:"JSON",
