    ...
    <div class="row">
      ...
      <div id="aside" class="col-md-3">
        ...
        <div class="aside">
          ...
          <p id="price_show">100000 - 4000000</p>
              ...
              <div class="store-grid">
                <form class="form-inline">
                  <div class="input-group">
                    ...
                    <input class="form-control mr-sm-2" type="search" id="search_text" placeholder="Cari Furnitur" style="width: 400px"  aria-describedby="basic-addon1">
                  </div>
                </form>
              </div>
            </div>
...
$(document).ready(function(){
    ...
    function filter_data(page)
    {
        ...
        $.ajax({
            url:"<?php echo base_url(); ?>kategori/fetch_furnitur/"+page,
            method:"POST",
            dataType:"JSON",
